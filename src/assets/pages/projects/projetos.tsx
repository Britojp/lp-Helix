...
import { Brain, Users, TrendingUp, Zap, BarChart2, Shield } from 'lucide-react'

export default function AILeadManagement() {
  return (
    <div className="min-h-screen bg-[#1a1a2e] text-white py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold mb-4 text-center">HelixAI: Inteligência Artificial para Manipulação de Leads</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              O HelixAI é nossa solução de ponta que utiliza inteligência artificial avançada para otimizar todo o processo de gestão de leads. 
              Desde a captação até a conversão, nossa IA analisa, segmenta e prioriza leads com precisão inigualável, 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-[#1a1a2e] border-[#4B53DB]">
              <CardHeader>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-6">Pronto para Revolucionar sua Gestão de Leads?</h2>
          <p className="text-xl text-gray-300 mb-8">
            Descubra como o HelixAI pode impulsionar suas conversões e otimizar seu funil de vendas.
          </p>
          <Button className="bg-[#714ADC] hover:bg-[#4B53DB] hover:scale-105 transition-transform text-white text-lg py-6 px-8">
...
const features = [
  { name: "Análise preditiva de leads", icon: Brain },
...
const benefits = [
  ...
  {
    title: "Otimização do Tempo da Equipe de Vendas",
    description: "Permita que sua equipe de vendas foque nos leads mais promissores, aumentando a eficiência.",
    icon: Users
  },
  {
    title: "Insights Acionáveis",
    description: "Obtenha insights profundos sobre o comportamento dos leads para refinar suas estratégias de marketing e vendas.",
    icon: BarChart2
  }
]

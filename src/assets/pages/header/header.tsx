...
import background from "../../video/background-main.mp4"; 
  ...
  return (
    <div className="relative min-h-screen overflow-hidden h-full bg-fixed">
      ...
      <div className="relative z-20 h-full flex flex-col ">
        ...
        <div className="container mx-auto px-4 mt-16 md:mt-26">
          <h1 className="text-5xl font-bold tracking-tight text-white text-center md:text-center md:pl-40 md:pr-40 md:text-7xl sm:pl-5">
        ...
        <main className="container mx-auto flex items-center flex-grow">
          <div className="mt-8 flex flex-col justify-center items-center md:items-center gap-8 w-full text-center md:text-center">
            <p className='font-semibold text-white  sm:text-2xl sm:pl-10 sm:pr-10 lg:text-lg md:text-lg'>Avance para o futuro com soluções tecnológicas sob medida. Agende sua consulta gratuita agora!</p>
